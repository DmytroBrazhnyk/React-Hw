...
export default function Card({ name, price, image, article, color,}){
    ...
    const [isCartModalVisible, setCartModalVisible] = useState(
        useSelector((state) => {
                state.products.products.find((product) => product.article === article).isCartModalVisible;
            }
    ))
    ...
    const toggleCartModal = () => {
        ...
        dispatch(setProductCartModalStatus({ productId: article, isCartModalVisible: !isCartModalVisible }));
    };
...
Card.propTypes = {
    ...
    isCartModalVisible: PropTypes.bool.isRequired
